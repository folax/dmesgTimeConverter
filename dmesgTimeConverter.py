...
def checkInputDate(inputStringDate):
    s=inputStringDate
    if s[0:2].isdigit() and s[2:3] == "-" and s[3:5].isdigit() and s[5:6] == "-" and s[6:10].isdigit() \
    and s[10:11]  == "_" and s[11:13].isdigit() and s[13:14] == ":" and s[14:16].isdigit() \
    and s[16:17] == ":" and s[17:19].isdigit():
        return True
    else:
...
# Check date in input argument;
if checkInputDate(sys.argv[2]):
